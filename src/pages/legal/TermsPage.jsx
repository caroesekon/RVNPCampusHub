...
export const TermsPage = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        ...
        setContent(res.data?.content || res.content || 'Terms of Service not available.');
      } catch { setContent('Failed to load Terms of Service.'); }
  ...
  return (
    <div className="pb-20">
      ...
      <h1 className="text-xl font-black text-[var(--color-text)] mb-4">Terms of Service</h1>
